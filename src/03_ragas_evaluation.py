...
# RAGAS 0.4 vẫn import integration VertexAI cũ của langchain-community.
# Bài lab không dùng VertexAI (evaluator lấy từ get_llm()), nên chỉ cần một
# placeholder tương thích khi bản LangChain mới đã bỏ module này.
if "langchain_community.chat_models.vertexai" not in sys.modules:
    try:
        ...
        class ChatVertexAI:  # pragma: no cover - chỉ dành cho import compatibility
            pass
...
SYSTEM_V1 = (
    ...
    "Nếu context không chứa thông tin liên quan, hãy nói thẳng là không biết.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    ...
    "Khi trả lời, hãy: 1) Tóm tắt câu trả lời chính, "
    "2) Trích dẫn thông tin từ context, "
    "3) Nêu rõ mức độ chắc chắn dựa trên dữ liệu được cung cấp. "
    "Luôn dựa trên context, không suy đoán thêm.\n\n"
    "Context:\n{context}"
)
